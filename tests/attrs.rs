...
fn attribute_types_mismatch() {
    ...
    let index_buffer =
        glium::IndexBuffer::new(&display, PrimitiveType::Points, &Vec::<u16>::new()).unwrap();
