...
fn vertex_binding_type_to_gl(ty: AttributeType) -> (gl::types::GLenum, gl::types::GLint, gl::types::GLint) {
    match ty {
        ...
        AttributeType::I64 => (gl::INT, 1, 1),
        AttributeType::I64I64 => (gl::INT, 2, 1),
        AttributeType::I64I64I64 => (gl::INT, 3, 1),
        AttributeType::I64I64I64I64 => (gl::INT, 4, 1),
        AttributeType::U64 => (gl::UNSIGNED_INT, 1, 1),
        AttributeType::U64U64 => (gl::UNSIGNED_INT, 2, 1),
        AttributeType::U64U64U64 => (gl::UNSIGNED_INT, 3, 1),
        AttributeType::U64U64U64U64 => (gl::UNSIGNED_INT, 4, 1),
