...
#[inline]
pub fn is_texture_1d_supported<C: ?Sized>(context: &C) -> bool
where
...
#[inline]
pub fn is_texture_2d_supported<C: ?Sized>(_: &C) -> bool
where
    C: CapabilitiesSource,
{
    true
...
#[inline]
pub fn is_texture_3d_supported<C: ?Sized>(context: &C) -> bool
where
    C: CapabilitiesSource,
{
...
#[inline]
pub fn is_texture_1d_array_supported<C: ?Sized>(context: &C) -> bool
where
    C: CapabilitiesSource,
{
...
#[inline]
pub fn is_texture_2d_array_supported<C: ?Sized>(context: &C) -> bool
where
    C: CapabilitiesSource,
{
    context.get_version() >= &Version(Api::Gl, 3, 0)
...
#[inline]
pub fn is_texture_2d_multisample_supported<C: ?Sized>(context: &C) -> bool
where
    C: CapabilitiesSource,
{
    ...
    C: CapabilitiesSource,
{
    context.get_version() >= &Version(Api::Gl, 3, 2)
        ...
        || context
            .get_extensions()
            .gl_oes_texture_storage_multisample_2d_array // FIXME: functions have an OES suffix, this isn't handled by glium
}

/// Returns true is cubemaps are supported.
#[inline]
pub fn is_cubemaps_supported<C: ?Sized>(context: &C) -> bool
where
    C: CapabilitiesSource,
{
...
#[inline]
pub fn is_cubemap_arrays_supported<C: ?Sized>(context: &C) -> bool
where
    C: CapabilitiesSource,
{
