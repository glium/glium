...
#[inline]
pub fn is_texture_1d_supported<C>(context: &C) -> bool
...
#[inline]
pub fn is_texture_2d_supported<C>(_: &C) -> bool
    where C: CapabilitiesSource
{
    true
}
...
#[inline]
pub fn is_texture_3d_supported<C>(context: &C) -> bool
    where C: CapabilitiesSource
{
    context.get_version() >= &Version(Api::Gl, 1, 2) ||
    context.get_version() >= &Version(Api::GlEs, 3, 0) ||
    context.get_extensions().gl_ext_texture3d || context.get_extensions().gl_oes_texture_3d        // FIXME: functions have an OES suffix, this isn't handled by glium
}

/// Returns true is one-dimensional texture arrays are supported.
#[inline]
pub fn is_texture_1d_array_supported<C>(context: &C) -> bool
    where C: CapabilitiesSource
{
...
#[inline]
pub fn is_texture_2d_array_supported<C>(context: &C) -> bool
    where C: CapabilitiesSource
{
    context.get_version() >= &Version(Api::Gl, 3, 0) ||
    context.get_version() >= &Version(Api::GlEs, 3, 0) ||
...
#[inline]
pub fn is_texture_2d_multisample_supported<C>(context: &C) -> bool
    where C: CapabilitiesSource
{
...
#[inline]
pub fn is_cubemaps_supported<C>(context: &C) -> bool
    where C: CapabilitiesSource
{
...
#[inline]
pub fn is_cubemap_arrays_supported<C>(context: &C) -> bool
    where C: CapabilitiesSource
{
