...
impl<T> BufferTexture<T> where [T]: BufferContent, T: TextureBufferContent + Copy {
    ...
    pub fn from_buffer<F>(context: &F,
                          buffer: Buffer<[T]>,
                          ty: BufferTextureType)
        ...
        let internal_format = if ctxt.version >= &Version(Api::Gl, 3, 0) ||
            ...
            match (T::get_type(), ty) {
                ...
                (TextureBufferContentType::U32U32U32, BufferTextureType::Unsigned)
                    ...
                    ctxt.extensions.gl_arb_texture_buffer_object_rgb32 => gl::RGB32UI,
                (TextureBufferContentType::I32I32I32, BufferTextureType::Integral)
                    if ctxt.version >= &Version(Api::Gl, 4, 0) ||
                    ctxt.extensions.gl_arb_texture_buffer_object_rgb32 => gl::RGB32I,
                (TextureBufferContentType::F32F32F32, BufferTextureType::Float)
                    if ctxt.version >= &Version(Api::Gl, 4, 0) ||
                    ctxt.extensions.gl_arb_texture_buffer_object_rgb32 => gl::RGB32F,
            ...
            match (T::get_type(), ty) {
                ...
                (TextureBufferContentType::U32U32U32, BufferTextureType::Unsigned) if ctxt.extensions
                                                                                          .gl_arb_texture_buffer_object_rgb32 =>
                    gl::RGB32UI,
                (TextureBufferContentType::I32I32I32, BufferTextureType::Integral) if ctxt.extensions
                                                                                          .gl_arb_texture_buffer_object_rgb32 =>
                    gl::RGB32I,
                (TextureBufferContentType::F32F32F32, BufferTextureType::Float) if ctxt.extensions
                                                                                       .gl_arb_texture_buffer_object_rgb32 =>
                    gl::RGB32F,
        ...
        let id = if ctxt.version >= &Version(Api::Gl, 4, 5) ||
            ...
            if ctxt.version >= &Version(Api::Gl, 3, 0) ||
               ctxt.version >= &Version(Api::GlEs, 3, 2) {
                ...
                unsafe {
                    ctxt.gl
                        .TexBufferARB(gl::TEXTURE_BUFFER, internal_format, buffer.get_buffer_id());
                }
            } else if ctxt.extensions.gl_ext_texture_buffer_object ||
               ctxt.extensions.gl_ext_texture_buffer {
                unsafe {
                    ctxt.gl
                        .TexBufferEXT(gl::TEXTURE_BUFFER, internal_format, buffer.get_buffer_id());
                }
            } else if ctxt.extensions.gl_oes_texture_buffer {
                unsafe {
                    ctxt.gl
                        .TexBufferOES(gl::TEXTURE_BUFFER, internal_format, buffer.get_buffer_id());
                }
