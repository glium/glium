...
fn main() {
    ...
    println!("This example draws 500 instanced teapots, obtained from a slice of a VertexBuffer \
              with 1000 teapot instances contained within it. Each teapot gets a random position and \
    ...
    support::start_loop(|| {
        ...
        target.draw((&vertex_buffer, per_instance.slice(0..500).unwrap().per_instance().unwrap()),
