...
![The famous Utah Teapot](tuto-01-teapot.png)
...
![The windows coordinates system](tuto-01-window-coords.svg)
...
![Finding the coordinates of our triangle](tuto-01-triangle-coords.svg)
...
![The graphics pipeline](tuto-01-pipeline.svg)
...
![Our final result](tuto-01-triangle.png)

**[You can find the entire source code here](https://github.com/tomaka/glium/blob/master/examples/tutorial-01.rs).**
